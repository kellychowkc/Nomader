                ...
                <Menu>
                  ...
                  <MenuList>
                    ...
                    {auth.isAdmin ? (
                      <LinkBox>
                        <MenuItem>
                          <NavLink className="controlPanel" to={"/control/"}>
                            Control Panel
                          </NavLink>
                        </MenuItem>
                      </LinkBox>
            ...
            <ol className="messages-list">
              {messageHistory.map((message: any, idx: number) => (
                ...
                >
                  ...
                  <Text className="message_content" fontSize={"1em"}>
                    {message.content}
                  </Text>
              ...
              {messages.map((message: any, idx: number) => (
                  ...
                  style={
                    message.ownedByCurrentUser
                      ? {
                          ...
                          marginLeft: "auto",
                          boxShadow: "1px 1px 2px 0px #DDDDDD",
                        }
                      : {
                          width: "auto",
                          maxWidth: "70%",
                ...
                >
                  <Text
                    ...
                    fontWeight={"medium"}
                  >
                    {message.ownedByCurrentUser ? "me:" : "other:"}
                  </Text>
                  <Text className="message_content" fontSize={"1em"}>
                    {message.body}
                  </Text>
                  <Text pb={2} lineHeight={"0"} textAlign={"right"}>
