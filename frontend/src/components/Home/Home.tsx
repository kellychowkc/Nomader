    ...
    >
      ...
      <VStack w="100%">
        ...
        >
          ...
          >
            <VStack className="displayName" px="5px" mx="0" align="flex-start">
        ...
        >
          ...
          >
            <HStack>
              <Text fontSize="1.5em" fontWeight="bold" letterSpacing={"wide"}>
                Category
              </Text>
            ...
            {categories.map((category: any, idx: number) => (
              ...
              >
                <Link to={category.path}>
                  <Icon
                    as={category.icon}
                    h={["30px", "40px", "50px", "60px", "65px"]}
                    w={["30px", "40px", "50px", "60px", "65px"]}
                    color="#FFFFFF"
                  />
                </Link>
              </Button>
        ...
        >
          ...
          >
            <Carousel
              ...
              responsive={true}
            >
              {interestList.map((item: InterestCardData, idx: any) => (
