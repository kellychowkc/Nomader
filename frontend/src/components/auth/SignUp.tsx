    ...
    <div className={styles.body}>
      ...
      <div className={styles.signInContainer}>
        <Stack spacing={4} mx={"auto"} maxW={"lg"} px={5}>
          <Stack align={"left"}>
            <Heading fontSize={"4xl"} color={"#b0d8bc"} fontWeight={"500"}>
              Sign up
            </Heading>
          </Stack>
          <form onSubmit={formik.handleSubmit}>
            {!nextPage ? (
              <Stack spacing={2}>
                ...
                <FormControl id="username" className={styles.box} isRequired>
                  <Input
                    id="username"
                    name="username"
                    onChange={formik.handleChange}
                ...
                <FormControl id="email" className={styles.box} isRequired>
                  <Input
                    id="email"
                    name="email"
                    onChange={formik.handleChange}
                ...
                <FormControl id="password" className={styles.box} isRequired>
                  <InputGroup>
                    <Input
                      id="password"
                      name="password"
                ...
                <FormControl className={styles.box} width={"100%"} isRequired>
                  <Select
                    id="country"
                    name="country"
                    onChange={formik.handleChange}
              ...
              <Stack spacing={4} pt={2}>
                  ...
                  <Stack direction={["column", "row"]} spacing={6}>
                    <Center>
                      <div className={styles.profileContainer}>
                        ...
                        ></input>
                        <p className={styles.title}>Upload Profile Picture</p>
                      </div>
                    </Center>
                  </Stack>
                </FormControl>
                ...
                <Stack spacing={4} direction={["column", "row"]}>
                  <Button
                    bgImage={"linear-gradient(to right,#314755, #26a0da)"}
                    className={styles.btn}
                    onClick={() => {
                      goBack();
                    }}
