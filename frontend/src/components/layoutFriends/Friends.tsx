    ...
    <Container w="full" h="full" maxW="max" p="0">
      ...
      >
        ...
        <VStack w="98vw">
          ...
          <Box w="80vw" maxH="30vh" scrollBehavior="smooth" overflowY="auto">
            <Table
              variant="striped"
              colorScheme="teal"
              w="100%"
            ...
            >
              ...
              <Tbody>
                  ...
                  <Td>
                    <HStack>
                      ...
                      <VStack align="left">
                        ...
                        <Text className="username">ericishandsome</Text>
                      </VStack>
                    </HStack>
                  </Td>
                  <Td>
                ...
                {friendsList.map((friend: IFriends, idx: number) => (
                  <Tr key={idx}>
                    <Td>
                      <HStack>
                        <Box className="friendAvatar">
                          <Circle size="30px" bg={friend.avatar} />
                        </Box>
                        <VStack align="left">
                          <Text className="nickname" fontWeight="bold">
                            {friend.name}
                          </Text>
                          <Text className="username">{friend.username}</Text>
                        </VStack>
                      </HStack>
                    </Td>
                    <Td>
