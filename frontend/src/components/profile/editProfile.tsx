          ...
          <Flex minH={"full"} align={"center"} justify={"center"}>
            <Stack>
              <form onSubmit={formik.handleSubmit}>
                  ...
                  <Box m={3}>
                    <FormControl id="first_name">
                      ...
                      <Input
                        ...
                        name="first_name"
                        onChange={formik.handleChange}
                        placeholder={profileList?.first_name}
                        _placeholder={{
                          color: "gray.500",
                        }}
                        type="text"
                  ...
                  <Box m={3} w="90%">
                    ...
                    >
                      ...
                      <Textarea
                        ...
                        minH="8rem"
                        w="85%"
                        placeholder={profileList?.information}
                        _placeholder={{
                          color: "gray.500",
                        }}
                ...
                <Box fontSize="sm" color="#363636" className={styles.timeBox}>
                  <Text>Member since: {profileList?.created_at}</Text>
