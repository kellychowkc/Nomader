...
export function ModalUserProfileDetail(props: Props) {
  ...
  const formik = useFormik({
    initialValues: {
      username: props.userProfile?.username ? props.userProfile?.username : "",
      ...
      phone_num: "",
      birthday: props.userProfile?.birthday ? props.userProfile?.birthday : "",
      ...
      emergency_contact_person: props.userProfile?.emergency_contact_person
  ...
  return (
    <ModalContent>
      ...
      <form onSubmit={formik.handleSubmit}>
              ...
              <Box m={1} h="min-content" w="90%">
                <FormControl id="emergency_contact_person">
                  ...
                  <Input
                    ...
                    type="text"
                    value={formik.values.emergency_contact_person}
                    onChange={formik.handleChange}
                  />
                </FormControl>
              </Box>
              ...
              <Box m={1} h="min-content" w="90%">
                <FormControl id="emergency_contact_number">
                  ...
                  <Input
                    ...
                    type="text"
                    value={formik.values.emergency_contact_num}
                    onChange={formik.handleChange}
                  />
                </FormControl>
              </Box>
        ...
        <ModalFooter>
          <Button colorScheme="blue" mr={3} onClick={props.disclosure.onClose}>
            Close
          </Button>
          <Button
            colorScheme="yellow"
